...
public class ExceptionMessages {
    public static final String WORKER_NAME_NULL_OR_EMPTY = "Worker name cannot be null or empty."; //used
    ...
    //Alex
    public static final String PLANE_TYPE_DOESNT_EXIST = "Plane type doesn't exist.";
